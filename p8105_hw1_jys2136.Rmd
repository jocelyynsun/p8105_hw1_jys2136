...
For the vectors that include characters ("vec_fac" and "vec_char"), I receive a warning
message informing that the argument is not numeric or logical. R produces "NA" as a result. I am able to receive results for "random_samp" and "vec_pos" because they contain numerical values. This exercise shows that R does not compute the mean for non-numeric or character values.
