...
For the vectors that include characters (`vec_fac` and `vec_char`), I receive a warning message informing that the argument is not numeric or logical. R produces a warning message and `NA` as a result. 
